...
class AgentServiceTest {
    ...
    private final AgentService service = new AgentService(agents, new CurrentProfileService(profiles), mock(AgentPromptRepository.class), new ValidateTutorPromptService());
